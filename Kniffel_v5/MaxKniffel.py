...
class MaxKniffel(Env):
    ...
    def step(self, action):
        ...
        if self.dicevalues.count(self.dicevalues[0]) == 5:
...
def golearn(allrolls):
    ...
    log_path = os.path.join("RL_Kniffel", "Kniffel_PPO", "LogKniffel")
    ppo_path = os.path.join("RL_Kniffel", "Kniffel_PPO", "Models", "PPO_MaxKniffel")


    env = MaxKniffel(allrolls)
    env = Monitor(env)
