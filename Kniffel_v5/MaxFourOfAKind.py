...
def golearn(allrolls):
    log_path = os.path.join("RL_Kniffel", "Kniffel_PPO", "LogFourOfAKind")
    ppo_path = os.path.join("RL_Kniffel", "Kniffel_PPO", "Models", "PPO_MaxFourOfAKind")


    env = MaxFourOfAKind(allrolls)
    env = Monitor(env)
