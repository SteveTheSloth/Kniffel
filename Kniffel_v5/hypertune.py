...
from baseline3_zoo.utils import linear_schedule
...
def get_model(env=gym.make("Kniffel-v0"), log_path=log_path, **kwargs):
    model = PPO("MultiInputPolicy", env, verbose=1, tensorboard_log=log_path, **kwargs)
    return model
