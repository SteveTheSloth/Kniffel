...
class MaxOnes(Env):
    def __init__(self, allrolls, rollcount=0):
    ...
    def step(self, action):
        ...
        onecount = self.dicevalues.count(1)
...
def golearn(allrolls):
    log_path = os.path.join("RL_Kniffel", "Kniffel_PPO", "LogOnes")
    ppo_path = os.path.join("RL_Kniffel", "Kniffel_PPO", "Models", "PPO_MaxOnes")


    env = MaxOnes(allrolls)
    env = Monitor(env)
